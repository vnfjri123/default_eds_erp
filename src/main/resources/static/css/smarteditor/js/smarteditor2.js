...
nhn.husky.SE2M_Hyperlink = jindo.$Class({
	...
	_generateAutoLink : function(sAll, sBreaker, sURL, sWWWURL, sHTTPURL) {
		...
		var sResult;
		if (sWWWURL){
			sResult = '<a href="http://'+sWWWURL+'" target ="_blank">'+sURL+'</a>';
		} else {
			sResult = '<a href="'+sHTTPURL+'" target ="_blank">'+sURL+'</a>';
		}
...
nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_TableCreator, {
	...
	$LOCAL_BEFORE_FIRST : function(){
		...
		this.aTableStyleByBorder = [
			'',
			'border="1" cellpadding="0" cellspacing="0" style="border:1px dashed #c7c7c7; border-left:0; border-bottom:0; border-collapse: collapse;"',
			'border="1" cellpadding="0" cellspacing="0" style="border:#BorderSize#px dashed #BorderColor#; border-left:0; border-bottom:0; border-collapse: collapse;"',
			'border="0" cellpadding="0" cellspacing="0" style="border:#BorderSize#px solid #BorderColor#; border-left:0; border-bottom:0; border-collapse: collapse;"',
			'border="0" cellpadding="0" cellspacing="1" style="border:#BorderSize#px solid #BorderColor#; border-collapse: collapse;"',
			'border="0" cellpadding="0" cellspacing="1" style="border:#BorderSize#px double #BorderColor#;border-collapse: collapse;"',
			'border="0" cellpadding="0" cellspacing="1" style="border-width:#BorderSize*2#px #BorderSize#px #BorderSize#px #BorderSize*2#px; border-style:solid;border-color:#BorderColor#;border-collapse: collapse;"',
			'border="0" cellpadding="0" cellspacing="1" style="border-width:#BorderSize#px #BorderSize*2#px #BorderSize*2#px #BorderSize#px; border-style:solid;border-color:#BorderColor#;border-collapse: collapse;"'
		];
...
nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_TableEditor, {
	...
	_assignHTMLObjects : function(){
        ...
        this.elPanelAlign0 = jindo.$$.getSingle("BUTTON.se2_align0", this.elQELayer);//테이블위치
        this.elPanelAlign1 = jindo.$$.getSingle("BUTTON.se2_align1", this.elQELayer);//테이블위치
        this.elPanelAlign2 = jindo.$$.getSingle("BUTTON.se2_align2", this.elQELayer);//테이블위치
...
*/
		...
		this.oApp.registerBrowserEvent(this.elPanelAlign0, "click", "TABLE_ALIGN_PALETTE");//이벤트설정
        this.oApp.registerBrowserEvent(this.elPanelAlign1, "click", "TABLE_ALIGN_PALETTE");
        this.oApp.registerBrowserEvent(this.elPanelAlign2, "click", "TABLE_ALIGN_PALETTE");
...
//			this.elSelectBoxTemplate.style.position = "static";
	...
	// true: Undim
	// false(default): Dim
	$ON_TABLE_ALIGN_PALETTE : function(wevE){//임추가
        ...
        if(welButtonEvent.hasClass("left")){
			elTable.style.float="left";
			elTable.style.margin="0 auto";
            //elTable.attri("style", "float:left; margin:'0 auto'");

        }else if(welButtonEvent.hasClass("right")){
			elTable.style.float="right";
			elTable.style.margin="0 auto";
        }else{
			elTable.style.float="none";
			elTable.style.margin="0 auto";
        }
    },
