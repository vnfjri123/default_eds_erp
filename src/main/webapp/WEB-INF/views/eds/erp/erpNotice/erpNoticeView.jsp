...
<script>
    ...
    async function init() {
        ...
        // sideBar 열기
        const menuItems = window.parent.document.querySelectorAll('.nav-sidebar > .nav-item');
        for (const menuItem of menuItems) {
            if (menuItem.innerText === 'ERP') {
                menuItem.classList.add('menu-is-opening', 'menu-open');
                break; // 'ERP'을 찾으면 루프 종료
            }
        }
        ...
        mainSheet.resetData(edsUtil.getAjax("/erpNoticeView/selectERPNotice", param));
        ...
        $('#btnSave').on('click', () => {
            ...
            formData.append("divi", 'erpNotice');
            ...
            $.ajax({
                url: "/erpNoticeView/cudERPNotice",
                type: "POST",
                data: formData,
                async: false,
                enctype: 'multipart/form-data',
        ...
        mainSheet.on('click', async (e) => {
            ...
            if (e.targetType === 'cell') {
                ...
                var imageData = edsUtil.getAjax("/erpNoticeView/selectERPNoticeImageList", param);
                ...
                var siteData = edsUtil.getAjax("/erpNoticeView/selectERPNoticeByIndex", param);
                ...
                for (file of noticeFiles) {
                    ...
                    updateDropzone.displayExistingFile(mockFile, "/erpNoticeView/erpNoticeFilesLoad/" + params);
                }
...
// originalFile에는 있었으나 imgArray에 없는 파일들을 deletedFiles에 추가
            ...
            $.ajax({
                ...
                success: async function (result) {
                    ...
                    if (paramData.length > 0) await edsUtil.getAjax2("/erpNoticeView/deleteERPNoticeFile", paramData)
                    dropzoneRemoveArr = [];
                    ...
                    if (removeImage.length > 0) await edsUtil.getAjax2("/erpNoticeView/erpNoticeImageDelete", removeImage)
        ...
        $('#btnDelete').on('click', (e) => {
            ...
            $.ajax({
                ...
                success: async function (result) {
                    ...
                    if (paramData.length > 0) await edsUtil.getAjax2("/erpNoticeView/deleteERPNoticeFilesAll", paramData)
