...
<head>
	...
	<script>
		...
		$(document).ready(function () {
			...
			document.getElementById('busiNm').focus();
		});
		...
		async function init() {
			...
			baseGridList.setColumns([
				...
				{ header:'회사명',		name:'corpNm',		minWidth:250,	align:'left',	filter: { type: 'text', showApplyBtn: true, showClearBtn: true } },
				{ header:'사업장코드',	name:'busiCd',		minWidth:100,	align:'center',	filter: { type: 'text', showApplyBtn: true, showClearBtn: true } },
				{ header:'사업장명',		name:'busiNm',		minWidth:250,	align:'left',	filter: { type: 'text', showApplyBtn: true, showClearBtn: true } },
			...
			baseGridList.on('dblclick', ev => {
				doAction("baseGridList", "apply");
			});

			baseGridList.on('keydown', ev => {
				...
				<div style="background-color: #faf9f5;border: 1px solid #dedcd7;margin-top: 5px;margin-bottom: 5px;padding: 3px;">
					...
					<form class="form-inline" role="form" name="searchForm" id="searchForm" method="post">
						...
						<div class="form-group">
							<label for="busiCd">사업장코드 &nbsp;</label>
							<div class="input-group input-group-sm">
								<input type="text" class="form-control" style="width: 150px; font-size: 15px;" name="busiCd" id="busiCd" title="사업장코드">
							</div>
						</div>
						<div class="form-group" style="margin-left: 50px"></div>
						<div class="form-group">
							<label for="busiNm">사업장명 &nbsp;</label>
							<div class="input-group input-group-sm">
