...
<head>
	...
	<script>
		...
		$(document).ready(function () {
			...
			document.getElementById('carNm').focus();
		});
			...
			if (sheetNm == 'baseGridList') {
				switch (sAction) {
					...
					case "apply"://선택
						...
						param.sumCumuMile = baseGridList.getValue(row.rowKey, "sumCumuMile");
		...
		<div style="background-color: #faf9f5;border: 1px solid #dedcd7;margin-top: 5px;margin-bottom: 5px;padding: 3px;">
			...
			<form class="form-inline" role="form" name="searchForm" id="searchForm" method="post" onsubmit="return false;">
				...
				<!-- <div class="form-group">
					<label for="carDivi">차량구분 &nbsp;</label>
					<div class="input-group input-group-sm">
						<select type="text" class="form-control" style="width: 100px; font-size: 15px;" name="carDivi" id="carDivi" title="차량구분"></select>
					</div>
				</div> -->
				<!-- <div class="form-group" style="margin-left: 50px"></div> -->
				<div class="form-group">
					<label for="carNm">검색 &nbsp;</label>
					<div class="input-group input-group-sm">
