						...
						<div class="card-body">
							<div class="row">
								<div class="col-sm-4">
									...
									<div class="form-group">
									<label>합계금액(견적)</label>
									<input type="text" class="form-control" placeholder="입력 ..." name="totAmt2" id="totAmt2" onKeyup="this.value=this.value.replace(/[^,0-9]/g,'');" style="background-color: yellow">
									</div>
									<!-- /.form-group -->
								</div>
								<div class="col-sm-4">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="입력 ..." name="margin" id="margin" style="background-color: yellow">
									</div>
								</div>
		 ...
		 ***********************************************************************/
		 edmsEstGridItem = new tui.Grid({
			...
			edmsEstGridItem.setColumns([
				...
				// hidden(숨김)
				{ header:'과세',			name:'vatDivi',		width:40, minWidth:30,	align:'center',	defaultValue: '',	editor:{type:'select',options: {listItems:setCommCode("COM006")}},	formatter: 'listItemText', hidden:true},
				{ header:'TAX',			name:'taxDivi',		width:40, minWidth:30,	align:'center',	defaultValue: '',	editor:{type:'select',options: {listItems:setCommCode("COM007")}},	formatter: 'listItemText', hidden:true},
				{ header:'단가',			name:'cost',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}, hidden:true},
				{ header:'공급가액',		name:'supAmt',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}, hidden:true},
				{ header:'부가세액',		name:'vatAmt',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}, hidden:true},
				{ header:'합계금액',		name:'totAmt',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}, hidden:true},
				{ header:'단가',			name:'cost2',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}, hidden:true},
				{ header:'공급가액',		name:'supAmt2',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}, hidden:true},
				{ header:'부가세액',		name:'vatAmt2',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}, hidden:true},
				{ header:'순번',			name:'seq',		width:100, hidden:true},
			]);
		...
		if (sheetNm == 'edmsEstGridItem') {
				switch (sAction) {
					case "search":// 조회
						...
						console.log(edsUtil.getAjax("/EDMS_EST_REPORT/selectEstItemList", param))
