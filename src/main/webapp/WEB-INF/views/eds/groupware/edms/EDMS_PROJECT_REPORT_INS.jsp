...
<div style="position:relative">
	<section class="content-header">
		<div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-12">
	            <h3 class="m-auto">프로젝트 등록품의				<div class="float-right">
					<div class="container">
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="입력 ..." name="submitNm" id="submitNm" required value="프로젝트 등록품의 - ">
										</div>
										<!-- /.form-group -->
									</div>
								</div>
