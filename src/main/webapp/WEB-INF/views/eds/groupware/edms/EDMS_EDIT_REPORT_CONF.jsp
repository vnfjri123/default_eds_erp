...
<head>
	...
	<%@ include file="/WEB-INF/views/comm/common-include-grid.jspf"%><%-- tui grid --%>ㄹ
	<!-- adminlte -->
							...
							<div class="row">
								<div class="col-md-12">
								  <div class="card card-outline card-info">
									...
									<!-- /.card-header -->
									<div class="card-body p-3" id="editerAreaResult" name="editerAreaResult">
									</div>
...
<script>
	...
	async function TEMPFUNCTIONGDATA()
	{
		...
		//document.getElementById("editAreaResult").innerHTML=document.getElementById("editArea").value;//html 변형
