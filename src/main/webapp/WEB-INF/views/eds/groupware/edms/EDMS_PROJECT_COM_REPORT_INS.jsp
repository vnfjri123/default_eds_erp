...
<div style="position:relative">
	<section class="content-header">
		<div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-12">
	            <h3 class="m-auto">프로젝트 준공 품의				<div class="float-right">
					<div class="container">
			...
			<div class="row" >
				<div class="col-md-12">
					<form name="edmsGridItemForm" id="edmsGridItemForm" method="post" onsubmit="return false;">
							...
							<div class="card-body">
								<div class="row">
									<div class="col-sm-12">
										...
										<label>아래와 같이 프로젝트 준공을 품의하오니, 재가하여 주시기 바랍니다. </label>
										</div>
										<!-- /.form-group -->
									</div>
								</div>
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="입력 ..." name="submitNm" id="submitNm" required value="프로젝트 준공품의 - ">
										</div>
										<!-- /.form-group -->
									</div>
								</div>
						...
						<div class="card card-warning card-outline">
							<div class="card-header">
								<label class="card-title">준공금액</label>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-sm-4">
										...
										<div class="form-group">
											<label>합계금액(준공)</label>
											<input type="text" class="form-control" placeholder="입력 ..." name="totAmt5" id="totAmt5" onKeyup="this.value=this.value.replace(/[^,0-9]/g,'');" readonly value="0" style="background-color: yellow">
										</div>
										<!-- /.form-group -->
									</div>
									<div class="col-sm-4">
										<!-- text input -->
										<div class="form-group">
											<label>영업이익(준공합계금액-준공매입금액)</label>
											<input type="text" class="form-control" placeholder="입력 ..." name="profit3" id="profit3" readonly value="0" style="background-color: yellow">
										</div>
										<!-- /.form-group -->
									</div>
									<div class="col-sm-4">
										...
										<div class="form-group">
											<label>영업이익율(예상)</label>
											<input type="text" class="form-control" placeholder="입력 ..." name="margin3" id="margin3" readonly value="0" style="background-color: yellow">
										</div>
										<!-- /.form-group -->
									</div>
									<div class="col-sm-4 d-none">
										...
										<div class="form-group">
											<label>공급가액</label>
											<input type="text" class="form-control" placeholder="입력 ..." name="supAmt5" id="supAmt5" onKeyup="this.value=this.value.replace(/[^,0-9]/g,'');" value="0">
										</div>
										<!-- /.form-group -->
									</div>
									<div class="col-sm-4 d-none">
										...
										<div class="form-group">
											<label>부가세액</label>
											<input type="text" class="form-control" placeholder="입력 ..." name="vatAmt5" id="vatAmt5" onKeyup="this.value=this.value.replace(/[^,0-9]/g,'');" value="0">
										</div>
										<!-- /.form-group -->
									</div>
								</div>
...
<script>
	...
	async function init() {
				...
				header: {
					...
					complexColumns: [
						...
						},*/
						{
							header: '계약',
							name: 'amt4',
							childNames: ['cost','supAmt','vatAmt','totAmt','cost3','supAmt3','vatAmt3','totAmt3']
						},
						/*{
							header: '계약금액',
							name: 'amt3',
						...
						},*/
						{
							header: '준공',
							name: 'amt5',
							childNames: ['cost4','supAmt4','vatAmt4','totAmt4','cost5','supAmt5','vatAmt5','totAmt5']
						},
					],
				},
				columns:[],
		...
		edmsEstGridItem.setColumns([
			...
			{ header:'준공합계금액',	name:'totAmt5',		width:100,		align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
			{ header:'매입단가',		name:'cost4',		width:100,		align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
			{ header:'매입공급가액',	name:'supAmt4',		width:100,		align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
			{ header:'매입부가세액',	name:'vatAmt4',		width:100,		align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
			{ header:'매입합계금액',	name:'totAmt4',		width:100,		align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
			...
			{ header:'단가',			name:'cost5',		minWidth:100,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'},	hidden:true },
			{ header:'공급가액',		name:'supAmt5',		minWidth:100,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'},	hidden:true },
			{ header:'부가세액',		name:'vatAmt5',		minWidth:100,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'},	hidden:true },
		...
		edmsEstGridItem.on('editingFinish',async ev => {
			...
			var cost4 = edmsEstGridItem.getValue(rowKey, 'cost4');
			var supAmt4 = edmsEstGridItem.getValue(rowKey, 'supAmt4');
			var vatAmt4 = edmsEstGridItem.getValue(rowKey, 'vatAmt4');
			var totAmt4 = edmsEstGridItem.getValue(rowKey, 'totAmt4');

			var cost5 = edmsEstGridItem.getValue(rowKey, 'cost5');
			var supAmt5 = edmsEstGridItem.getValue(rowKey, 'supAmt5');
			var vatAmt5 = edmsEstGridItem.getValue(rowKey, 'vatAmt5');
			var totAmt5 = edmsEstGridItem.getValue(rowKey, 'totAmt5');
			...
			switch (columnName) {
				case 'qty' :
					if (vatDivi === "01") {// 과세, 면세 구분
						...
						/* 준공매입금액 */
						if(vatAmt === 0){ // => 우리회사만 이런거니까 다른회사에 팔때는 없애야함
							supAmt4 = cost4 * qty; // 공급가액
							vatAmt4 = 0; // TAX
							totAmt4 = supAmt4; // 합계금액
						}else{
							supAmt4 = cost4 * qty; // 공급가액
							vatAmt4 = supAmt4 * 0.1; // TAX
							totAmt4 = supAmt4 * 1.1 // 합계금액
						}
						// => 우리회사만 이런거니까 다른회사에 팔때는 풀어야함
						/*supAmt4 = totAmt4 / 1.1; // 공급가액
						vatAmt4 = supAmt4 * 0.1; // TAX
						cost4 = supAmt4 /qty; // 단가*/
						/* 준공합계금액 */
						supAmt5 = totAmt5 / 1.1; // 공급가액
						vatAmt5 = supAmt5 * 0.1; // TAX
						cost5 = supAmt5 /qty; // 단가
					} else {// 면세, 영세
						/* 매입가 */
						supAmt = totAmt; // 공급가액
						vatAmt = 0; // TAX
						...
						cost3 = supAmt3 /qty; // 단가
						/* 준공매입금액 */
						supAmt4 = totAmt4; // 공급가액
						vatAmt4 = 0; // TAX
						cost4 = supAmt4 /qty; // 단가
						/* 준공합계금액 */
						supAmt5 = totAmt5; // 공급가액
						vatAmt5 = 0; // TAX
						cost5 = supAmt5 /qty; // 단가
					}
					break;
				...
				case 'cost4' :
					if (vatDivi === "01") {// 과세, 면세 구분
						if (taxDivi === "01") {// 별도, 포함 구분
							/* 매입가 */
							supAmt4 = qty * cost4; // 공급가액
							vatAmt4 = supAmt4 * 0.1; // TAX
						} else {//포함
							/* 매입가 */
							supAmt4 = qty * cost4 / 1.1; // 공급가액
							vatAmt4 = qty * cost4 - supAmt4; // TAX
						}
					} else {// 면세, 영세
						/* 매입가 */
						supAmt4 = qty * cost4; // 공급가액
				...
				case 'cost5' :
					if (vatDivi === "01") {// 과세, 면세 구분
						if (taxDivi === "01") {// 별도, 포함 구분
							/* 할인가 */
							supAmt5 = qty * cost5; // 공급가액
							vatAmt5 = supAmt5 * 0.1; // TAX
						} else {//포함
							/* 할인가 */
							supAmt5 = qty * cost5 / 1.1; // 공급가액
							vatAmt5 = qty * cost5 - supAmt5; // TAX
						}
					} else {// 면세, 영세
						/* 할인가 */
						supAmt5 = qty * cost5; // 공급가액
				...
				case 'supAmt4' :
					if (vatDivi === "01") {// 과세, 면세 구분
						/* 매입가 */
						cost4 = supAmt4/qty; // 단가
						vatAmt4 = supAmt4/10; // TAX
						totAmt4 = supAmt4/1.1; // 공급가액
					} else {// 면세, 영세
						/* 매입가 */
						cost4 = supAmt4/qty; // 단가
						vatAmt4 = 0; // TAX
						totAmt4 = supAmt4; // 공급가액
					}
					break;
				case 'supAmt5' :
					if (vatDivi === "01") {// 과세, 면세 구분
						/* 할인가 */
						cost5 = supAmt5/qty; // 단가
						vatAmt5 = supAmt5/10; // TAX
						totAmt5 = supAmt5/1.1; // 공급가액

					} else {// 면세, 영세
						/* 할인가 */
						cost5 = supAmt5/qty; // 단가
						vatAmt5 = 0; // TAX
						totAmt5 = supAmt5; // 공급가액
					}
					break;
				case 'totAmt' :
					if (vatDivi === "01") {// 과세, 면세 구분
				...
				case 'totAmt4' :
					if (vatDivi === "01") {// 과세, 면세 구분
						/* 매입가 */
						supAmt4 = totAmt4/11*10; // 공급가액
						vatAmt4 = totAmt4/11; // TAX
						cost4 = supAmt4/qty; // 단가
					} else {// 면세, 영세
						/* 매입가 */
						supAmt4 = totAmt4; // 공급가액
				...
				case 'totAmt5' :
					if (vatDivi === "01") {// 과세, 면세 구분
						/* 할인가 */
						supAmt5 = totAmt5/11*10; // 공급가액
						vatAmt5 = totAmt5/11; // TAX
						cost5 = supAmt5/qty; // 단가
			...
			/* 견적가 */
			if(cost4 < 0||supAmt4 < 0||vatAmt4 < 0||totAmt4 < 0){ // 특별 DC 처리
				cost4 = cost4*(-1);
				supAmt4 = supAmt4*(-1);
				vatAmt4 = vatAmt4*(-1);
				totAmt4 = totAmt4*(-1);
				cost4 = Math.round(cost4)*(-1); // 올림
				supAmt4 = Math.round(supAmt4)*(-1);  // 반올림
				vatAmt4 = Math.round(vatAmt4)*(-1); // 반올림
				totAmt4 = supAmt4 + vatAmt4; // 합계
			}else{
				cost4 = Math.round(cost4); // 올림
				supAmt4 = Math.round(supAmt4);  // 반올림
				vatAmt4 = Math.round(vatAmt4); // 반올림
				totAmt4 = supAmt4 + vatAmt4; // 합계
			}
			edmsEstGridItem.setValue(rowKey, "cost4", cost4);
			edmsEstGridItem.setValue(rowKey, "supAmt4", supAmt4);
			edmsEstGridItem.setValue(rowKey, "vatAmt4", vatAmt4);
			edmsEstGridItem.setValue(rowKey, "totAmt4", supAmt4 + vatAmt4);

			/* 할인가 */
			cost5 = Math.round(cost5); // 올림
			supAmt5 = Math.round(supAmt5);  // 반올림
			vatAmt5 = Math.round(vatAmt5); // 반올림
			totAmt5 = supAmt5 + vatAmt5; // 합계
			edmsEstGridItem.setValue(rowKey, "cost5", cost5);
			edmsEstGridItem.setValue(rowKey, "supAmt5", supAmt5);
			edmsEstGridItem.setValue(rowKey, "vatAmt5", vatAmt5);
			edmsEstGridItem.setValue(rowKey, "totAmt5", supAmt5 + vatAmt5);
		...
		if (sheetNm == 'edmsEstGridItem') {
				switch (sAction) {
					case "search":// 조회
						...
						edmsEstGridItem.resetData(data); // 데이터 set
					...
					case "input":// 신규
						...
						appendedData.cost4 = 0;
						appendedData.supAmt4 = 0;
						appendedData.vatAmt4 = 0;
						appendedData.totAmt4 = 0;
						appendedData.cost5 = 0;
						appendedData.supAmt5 = 0;
						appendedData.vatAmt5 = 0;
						appendedData.totAmt5 = 0;
	...
	async function TEMPFUNCTIONGDATA()
	{
		...
		params.keyCd=document.getElementById("keyCd").value;
		...
		/* 품목 조회 */
		await doAction("edmsEstGridItem", "search");
		document.getElementById("keyCd").value=params.keyCd;
	...
	async function applyTotAmt(){
		...
		for (let i = 0; i < dataLen; i++) {
			...
			supAmtAll4 += Number(data[i].supAmt4);
			vatAmtAll4 += Number(data[i].vatAmt4);
			totAmtAll4 += Number(data[i].totAmt4);
			supAmtAll5 += Number(data[i].supAmt5);
			vatAmtAll5 += Number(data[i].vatAmt5);
			totAmtAll5 += Number(data[i].totAmt5);
		}
		...
		edmsEstGridItem.setSummaryColumnContent('supAmt4',edsUtil.addComma(supAmtAll4));
		edmsEstGridItem.setSummaryColumnContent('vatAmt4',edsUtil.addComma(vatAmtAll4));
		edmsEstGridItem.setSummaryColumnContent('totAmt4',edsUtil.addComma(totAmtAll4));

		edmsEstGridItem.setSummaryColumnContent('supAmt5',edsUtil.addComma(supAmtAll5));
		edmsEstGridItem.setSummaryColumnContent('vatAmt5',edsUtil.addComma(vatAmtAll5));
		edmsEstGridItem.setSummaryColumnContent('totAmt5',edsUtil.addComma(totAmtAll5));
		...
		document.getElementById('supAmt5').value=edsUtil.addComma(supAmtAll5);
		document.getElementById('vatAmt5').value=edsUtil.addComma(vatAmtAll5);
		document.getElementById('totAmt5').value=edsUtil.addComma(totAmtAll5);
		...
		profit3.value = edsUtil.addComma(totAmtAll5 - totAmtAll4);

		if(!isNaN(Number(edsUtil.removeComma(profit3.value)))){

			var value= Math.round((totAmtAll5 - totAmtAll4)/totAmtAll5*10000)/100;
