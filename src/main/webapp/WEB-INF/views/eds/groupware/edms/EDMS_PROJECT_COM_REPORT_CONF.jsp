					...
					<div class="row" >
						<div class="col-md-12">
								...
								<div class="card card-lightblue card-outline">
									...
									<div class="card-body p-0 overflow-auto">
									  <table class="table table-bordered">
										...
										<tr>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 100px;width: 15%;">품목명</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 200px;width: 25%;">규격</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 40px; width: 5%;">단위</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 40px; width: 5%;">수량</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px; width: 10%;">견적합계금액</th>
											<th colspan="4" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 240px; width: 20%;">계약</th>
											<th colspan="4" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 240px; width: 20%;">준공</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 150px;width: 35%;">적요</th>
										</tr>
										<tr>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px;width: 10%;">계약합계금액</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px;width: 10%;">매입단가</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px;width: 10%;">매입공급가액</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px;width: 10%;">매입부가세액</th>
											<%--											  <th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px;width: 10%;">매입합계금액</th>--%>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px; width: 10%;">준공합계금액</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px;width: 10%;">매입단가</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px;width: 10%;">매입공급가액</th>
											<th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px;width: 10%;">매입부가세액</th>
											<%--											  <th rowspan="2" style="padding-left: 0;text-align:center;vertical-align:middle;min-width: 120px;width: 10%;">매입합계금액</th>--%>
							...
							<div class="row">
								...
								<div class="card card card-lightblue card-outline">
									<div class="card-header" >
										<label class="card-title">추가 첨부파일 <small><em>파일을 목록입니다.</em></small></label>
									</div>
									<div class="card-body">
		 ...
		 ***********************************************************************/
		 edmsEstGridItem = new tui.Grid({
				...
				header: {
					...
					complexColumns: [
						...
						},
						{
							header: '견적가',
							name: 'amt2',
							childNames: ['cost2','supAmt2','vatAmt2','totAmt4']
						},
					],
				},
				columns:[],
			...
			edmsEstGridItem.setColumns([
				...
				{ header:'합계금액',		name:'totAmt4',		width:100,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'},	hidden:true },
	...
	async function selectItem()
	{
		...
		console.log(data)
		  ...
		  for (const obj of data) {
			  ...
			  itemNmCell.setAttribute("class","itemAlign");
			  ...
			  const totAmt5Cell = document.createElement('td');
			  totAmt5Cell.setAttribute("class","numberAlign");
			  totAmt5Cell.textContent = edsUtil.addComma(obj['totAmt5'])+'원';
			  dataRow.appendChild(totAmt5Cell);

			  const costCell4 = document.createElement('td');
			  costCell4.setAttribute("class","numberAlign");
			  costCell4.textContent = edsUtil.addComma(obj['cost4'])+'원';
			  dataRow.appendChild(costCell4);
			  const supAmtCell4 = document.createElement('td');
			  supAmtCell4.setAttribute("class","numberAlign");
			  supAmtCell4.textContent = edsUtil.addComma(obj['supAmt4'])+'원';
			  dataRow.appendChild(supAmtCell4);
			  const vatAmtCell4 = document.createElement('td');
			  vatAmtCell4.setAttribute("class","numberAlign");
			  vatAmtCell4.textContent = edsUtil.addComma(obj['vatAmt4'])+'원';
			  dataRow.appendChild(vatAmtCell4);
