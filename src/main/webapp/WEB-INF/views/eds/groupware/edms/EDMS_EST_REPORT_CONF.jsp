	...
	<div id="printid">
		<div style="position:relative" id="printtest">
			<nav class="navbar navbar-expand-sm navbar-whiht navbar-light bg-whiht fixed-top" id="navt">
				<a class="navbar-brand" href="#"><h3>프로젝트 견적품의</h3></a>
					...
					<div class="row" >
						<div class="col-md-12">
							<form name="edmsGridItemForm" id="edmsGridItemForm" method="post" onsubmit="return false;">
									...
									<div class="card-body">
										...
										<div class="row">
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="입력 ..." name="projNm" id="projNm" required readonly style="background-color: yellow">
												</div>
												<!-- /.form-group -->
											</div>
											<div class="col-sm-6">
												...
												<input type="text" class="form-control" placeholder="입력 ..." name="projPur" id="projPur" required readonly>
												</div>
												<!-- /.form-group -->
											</div>
										</div>
											...
											<div class="col-sm-2">
												...
												<div class="col-sm-2">
													<div class="form-group">
														...
														<select class="form-control select2" style="width: 100%;"name="projDivi" id="projDivi" disabled >
										...
										<div class="row">
											<div class="col-sm-3">
												<div class="form-group">
													<label>거래처</label>
													<input type="text" class="form-control" placeholder="입력 ..." name="custNm" id="custNm" readonly>
												</div>
												<!-- /.form-group -->
											</div>
											<div class="col-sm-3">
									...
									<div class="card-body">
										<div class="row">
											<div class="col-sm-4">
												...
												<div class="form-group">
													<label>합계금액(견적)</label>
													<input type="text" class="form-control" placeholder="입력 ..." name="totAmt2" id="totAmt2" readonly style="background-color: yellow">
												</div>
												<!-- /.form-group -->
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<label>영업이익(예상)</label>
													<input type="text" class="form-control" placeholder="입력 ..." name="profit" id="profit"readonly style="background-color: yellow">
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<label>영업이익율(예상)</label>
													<input type="text" class="form-control" placeholder="입력 ..." name="margin" id="margin"readonly style="background-color: yellow">
												</div>
											</div>
								...
								<!-- /.cnt-in -->
								<div class="card card-warning card-outline" hidden>
									<div class="card-header">
										<label class="card-title">견적가</label>
									</div>
									<div class="card-body">
										<div class="row">
											<div class="col-sm-4">
												...
												<div class="form-group">
													<label>공급가액</label>
													<input type="text" class="form-control" placeholder="입력 ..." name="supAmt2" id="supAmt2" readonly>
												</div>
												<!-- /.form-group -->
												</div>
											<div class="col-sm-4">
												...
												<div class="form-group">
													<label>부가세액</label>
													<input type="text" class="form-control" placeholder="입력 ..." name="vatAmt2" id="vatAmt2" readonly>
												</div>
												<!-- /.form-group -->
											</div>
										</div>
								...
								<div class="card card card-lightblue card-outline" hidden>
									<div class="card-header">
										<label class="card-title">품목</label>
									</div>
									<div class="card-body">
										<div class="row">
...
<script>
		 ...
		 ***********************************************************************/
		 edmsEstGridItem = new tui.Grid({
			...
			edmsEstGridItem.setColumns([
				{ header:'품목명',			name:'itemNm',		width:150, minWidth:30,	align:'left',	defaultValue: '',validation: {required:true}},
				{ header:'과세',			name:'vatDivi',		width:40, minWidth:30,	align:'center',	defaultValue: '',	editor:{type:'select',options: {listItems:setCommCode("COM006")}},	formatter: 'listItemText'},
				{ header:'TAX',				name:'taxDivi',		width:40, minWidth:30,	align:'center',	defaultValue: '',	editor:{type:'select',options: {listItems:setCommCode("COM007")}},	formatter: 'listItemText'},
				{ header:'규격',			name:'standard',	width:150, minWidth:30,	align:'center',	defaultValue: '',	editor:{type:'text'}	},
				{ header:'수량',			name:'qty',			width:60, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
				{ header:'단가',			name:'cost',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
				{ header:'공급가액',		name:'supAmt',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
				{ header:'부가세액',		name:'vatAmt',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
				{ header:'합계금액',		name:'totAmt',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
				{ header:'단가',			name:'cost2',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
				{ header:'공급가액',		name:'supAmt2',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
				{ header:'부가세액',		name:'vatAmt2',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
				{ header:'합계금액',		name:'totAmt2',		width:100, minWidth:30,	align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'}},
				{ header:'비고',			name:'note',		minWidth:150,	align:'center',	defaultValue: '',	editor:{type:'text'}},
				{ header:'순번',		name:'seq',		width:100,},
	...
	async function TEMPFUNCTIONGDATA()
	{
		...
		/*견적계산*/
		let totAmtAll2=edsUtil.removeComma(document.getElementById("totAmt2").value);
		let totAmtAll=edsUtil.removeComma(document.getElementById("totAmt").value);
		let margins=(((Number(totAmtAll2)-Number(totAmtAll))/Number(totAmtAll2))*100);
		document.getElementById('margin').value= (Math.floor(margins*100)/100)+"%";
		document.getElementById('profit').value=edsUtil.addComma((Number(totAmtAll2)-Number(totAmtAll)));
