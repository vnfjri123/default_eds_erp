	...
	<script>
		...
		function initApprovers(nowApprover,approvers,approversName,submitDivi)
		{
			...
			for(const data in appList)
			{
				...
				else if(appList[data]==nowApprover&&submitDivi=='04')
				{
					stan=true;	
					stanEl+=`
						<div class="pr-1 pl-1 m-auto">
							<div class="text-center">
								<i class="rowIcon fa fa-share bg-danger "></i>
							</div>
...
<body class="h-auto" style="min-height: calc(100% - 4.25rem);">
	<div style="position:relative">
		<nav class="navbar navbar-expand-sm navbar-whiht navbar-light bg-whiht fixed-top" id='navHeightBar' style>
			<a class="navbar-brand" href="#"><h3>결재완료함</h3></a>
								...
								<div class="card-tools">
									<div class="btn-group btn-group-toggle mr-2 mb-2 mr-auto ml-auto" data-toggle="buttons">
										<label class="btn btn-sm btn-primary active" onclick="addSubmitEl('homeTimeLine');">
										  ...
										  <span class="badge bg-info" id="allCom">0</span>
										</label>
										<label class="btn btn-sm btn-primary" onclick="addSubmitEl('homeTimeLine');">
										  <input type="radio" name="options" id="option_a2" autocomplete="off" value="03"> 승인
										  <span class="badge bg-success" id="com">0</span>
										</label>
										<label class="btn btn-sm btn-primary active" onclick="addSubmitEl('homeTimeLine');">
										  <input type="radio" name="options" id="option_a3" autocomplete="off" value="07"> 반려
										  <span class="badge bg-danger" id="cancelCom">0</span>
										</label>
									</div>
