	...
	<div id="printid">
		<div style="position:relative" id="printtest">
			<nav class="navbar navbar-expand-sm navbar-whiht navbar-light bg-whiht fixed-top" id="navt">
				<a class="navbar-brand" href="#"><h3>지출품의</h3></a>
											...
											<div class="card card-warning card-outline h-100">
												...
												<div class="card-body">
													<div class="form-group">
														<label>합계금액</label>
														<input type="text" class="form-control" placeholder="" name="totAmt" id="totAmt" readonly>
													</div>
													<div class="form-group">
														<label>공급가액</label>
														<input type="text" class="form-control" placeholder="" name="supAmt" id="supAmt" readonly>
													</div>
													<div class="form-group">
														<label>부가세액</label>
														<input type="text" class="form-control" placeholder="" name="vatAmt" id="vatAmt" readonly>
													</div>
												</div>
											</div>
										<!-- /.form-group -->
