...
<div style="position:relative" id="printid">
	<nav class="navbar navbar-expand-sm navbar-whiht navbar-light bg-whiht fixed-top" id="navt">
		<a class="navbar-brand" href="#"><h3>프로젝트 준공 품의</h3></a>
...
<script>
	...
	async function init() {
		...
		edmsEstGridItem.setColumns([
			...
			{ header:'매입합계금액',	name:'totAmt4',		width:100,		align:'right',	defaultValue: '',	formatter: function (value){return edsUtil.addComma(value.value);},	editor:{type:'text'},	hidden:true },
